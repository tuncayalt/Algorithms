...
{
    [TestClass]
    public class LexicoPermutatorTests
    {
        ...
        public void Setup()
        {
            _permutator = new LexicoPermutator<int>();
        }

        [TestMethod]
        public void LexicoPermutator_Permutate_NullList_ThrowException()
        {
            // Arrange
        ...
        [TestMethod]
        public void LexicoPermutator_Permutate_EmptyList_ReturnsEmptyList()
        {
            // Arrange
        ...
        [TestMethod]
        public void LexicoPermutator_Permutate_OneElementList_ReturnsSameList()
        {
            // Arrange
            var list = new List<int>
            {
        ...
        [TestMethod]
        public void LexicoPermutator_Permutate_TwoElementList_ReturnsPermutations()
        {
            // Arrange
            var list = new List<int>
            {
        ...
        [TestMethod]
        public void LexicoPermutator_Permutate_MoreElementList_ReturnsPermutations()
        {
            // Arrange
            var list = new List<int>
            {
